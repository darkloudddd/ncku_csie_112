...
public class HtmlParser {
    ...
    public static final int stockNum = 5000;
    ...
    public static StockInfo[] parser() {
        ...
        try {
            ...
            StockInfo[] stockInfo_clsArr2 = new StockInfo[nameNum];
            //stockInfo_clsArr = new StockInfo[nameNum];
            for (int i = 0; i < nameNum; i++) {
                stockInfo_clsArr2[i] = new StockInfo();
            }

            int idxOfStockInfo = 0;
            for (Element name : names) {
                // System.out.print("store name" + idxOfStockInfo + ", ");
                //stockInfo_clsArr[idxOfStockInfo] = new StockInfo();
                stockInfo_clsArr2[idxOfStockInfo].stockName = name.text();
                idxOfStockInfo++;
            }
            idxOfStockInfo = 0;
            ...
            for (Element price : prices) {
                ...
                stockInfo_clsArr2[idxOfStockInfo].stockPrice[day - 1] = Float.parseFloat(price.text());
                idxOfStockInfo++;
            }

            stockInfo_clsArr = stockInfo_clsArr2;
    ...
    public static void mode0(StockInfo[] stockInfo_clsArr) // file not exist
        ...
        if (!file.exists() || file.toString().equals("")) { // data.csv hasn't exist
            ...
            for (int idxOfStockInfoClsArr = 1; idxOfStockInfoClsArr < stockInfo_clsArr.length; idxOfStockInfoClsArr++) {

                if (stockInfo_clsArr[idxOfStockInfoClsArr].stockName != null) {
                    // System.out.print("content add name" + idxOfStockInfoClsArr + ", ");
        ...
        // System.out.print("content add price" + 0 + ", ");

        content += String.format("\n%.2f", stockInfo_clsArr[0].stockPrice[i]);
        for (int idxOfStockInfoClsArr = 1; idxOfStockInfoClsArr < stockInfo_clsArr.length; idxOfStockInfoClsArr++) {

            if (stockInfo_clsArr[idxOfStockInfoClsArr].stockName != null) {
                // System.out.print("content add price" + idxOfStockInfoClsArr + ", ");
    ...
    public static StockInfo[] storeToDataBase() {
        ...
        StockInfo[] stockInfo_clsArr = new StockInfo[names.length];
        for (int i = 0; i < names.length; i++) {
            stockInfo_clsArr[i] = new StockInfo();
        }

        for (int idxOfStockInfoClsArr = 0; idxOfStockInfoClsArr < names.length; idxOfStockInfoClsArr++) {
    ...
    public static void task1(StockInfo[] stockInfo_clsArr, String name, int start, int end) {
        ...
        for (int idxOfStockInfoClsArr = 0; idxOfStockInfoClsArr < stockInfo_clsArr.length; idxOfStockInfoClsArr++) {
