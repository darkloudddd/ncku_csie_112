...
public class mermaid_reader_0327_3 {
	...
	void read_file(String strFileName)
	{
        ...
        try {
            ...
            //int idxofisPublicArr = 0;
            //int idxofmemberNameArr = 0;
            //int idxofmemberName2Arr = 0;
            //int idxofmemberTypeArr = 0;
            //int idxofmemberFunctionTypeArr = 0;

            //int idxofClsInfoArr = 0;
    ...
    public static void main(String[] args) {
		...
		mermaid_reader_0327_3 reader = new mermaid_reader_0327_3();

		//reader.read_file_test();

		if( args.length > 0)
			reader.read_file("tc4.txt");
